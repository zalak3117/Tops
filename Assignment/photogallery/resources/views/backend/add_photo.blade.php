        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Add Photos</h4>
                      ...
                      <form method="post" action="{{url('/add_photo')}}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-message">Add Multiple Photos</label>
                            <input type="file" class="form-control" id="multi_photo" name="multi_photo[]" multiple/>
