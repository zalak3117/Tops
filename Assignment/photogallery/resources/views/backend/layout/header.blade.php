        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Gallary</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Form Layouts">Gallery</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="add_photo" class="menu-link">
                    <div data-i18n="Vertical Form">Add Photos</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="manage_photo" class="menu-link">
                    <div data-i18n="Horizontal Form">Manage Photos</div>
                  </a>
                </li>
              </ul>
            </li>
