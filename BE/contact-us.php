            ...
            <div class="row g-5 justify-content-center mb-5">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-light text-center h-100 p-5">
                        ...
                        <p class="mb-2">(+91)98240 77724</p>
                        <p class="mb-4">(+91)97373 20009</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="bg-light text-center h-100 p-5">
                        ...
                        <p class="mb-2">bhumiengg@yahoo.com</p>
                        <p class="mb-4"></p>
                        <a class="btn btn-primary px-4" href="mailto:bhumiengg@yahoo.com">Email Now <i
                                class="fa fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="bg-light text-center h-100 p-5">
                        ...
                        <p class="mb-2">BHUMI ENGINEERS, 1180-LAXMIKUNJ, BEHIND RIDDHI-SIDDHI FLATS, GORWA, VADODARA 390003, GUJARAT.</p>
                        
                        <a class="btn btn-primary px-4" href="https://goo.gl/maps/1180-LAXMIKUNJ,BEHIND RIDDHI-SIDDHI FLATS,GORWA,VADODARA 390003,GUJARAT,india"
