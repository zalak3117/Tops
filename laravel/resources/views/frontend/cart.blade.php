	    				...
	    				<table class="table">
							...
							@foreach($fetch as $d)
						      <tr class="text-center">
						        ...
						        <td class="product-remove"> <a href="delete_cart/{{$d->id}}"><span class="ion-ios-close"></span></a></td>
						        
						        <td class="image-prod"><img src="{{url('backend/assets/img/upload/product/'.$d->prod_image)}}" width="100px" alt=""></td>
