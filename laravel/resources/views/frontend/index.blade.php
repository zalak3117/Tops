...
@section('main_section')
    ...
    <section id="home-section" class="hero">
	      ...
	      <div class="slider-item" style="background-image: url({{url('frontend/images/bg6.jpg')}});">
	      ...
	      <div class="slider-item" style="background-image: url({{url('frontend/images/bg2.jpg')}});">
	      	<div class="overlay"></div>
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
		...
		<section class="ftco-section ftco-category ftco-no-pt">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<div class="row">
							<div class="col-md-6 order-md-last align-items-stretch d-flex">
								<div class="category-wrap-2 ftco-animate img align-self-stretch d-flex" style="background-image: url({{url('frontend/images/center.jpg')}});">
							...
							<div class="col-md-6">
								<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url({{url('frontend/images/skincare.jpg')}});">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="#">Skin Care</a></h2>
									</div>
								</div>
					...
					<div class="col-md-4">
						<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url({{url('frontend/images/hair2.jpg')}});">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="#">Hair</a></h2>
							</div>		
						</div>
						<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url({{url('frontend/images/makeupface.jpg')}});">
							<div class="text px-3 py-1">
    ...
    <section class="ftco-section">
		...
		<section class="ftco-section img" style="background-image: url({{url('frontend/images/bg24.jpg')}});">
    	<div class="container">
